...
class AssignmentsFetchSuccess extends AssignmentsState {
  ...
  AssignmentsFetchSuccess({
    ...
    required this.fetchMoreAssignmentsInProgress, required this.moreAssignmentsFetchError, required this.currentPage, required this.totalPage, this.subjectId,
  });
...
class AssignmentsCubit extends Cubit<AssignmentsState> {
  ...
  void fetchAssignments({
    required int isSubmitted, required int childId, required bool useParentApi, int? page,
    int? assignmentId,
    int? subjectId,
  }) {
