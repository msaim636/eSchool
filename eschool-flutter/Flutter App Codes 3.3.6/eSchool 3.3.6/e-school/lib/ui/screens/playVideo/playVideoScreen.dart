...
class PlayVideoScreen extends StatefulWidget {
  const PlayVideoScreen({
    required this.relatedVideos, required this.currentlyPlayingVideo, super.key,
  });
...
class _PlayVideoScreenState extends State<PlayVideoScreen>
  ...
  void loadYoutubeController() {
    ...
    _youtubePlayerController = YoutubePlayerController(
      ...
      flags: const YoutubePlayerFlags(hideThumbnail: true, hideControls: true),
    );
    assignedVideoController = true;
  }
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child:
                    currentlyPlayingStudyMaterialVideo.studyMaterialType ==
                        StudyMaterialType.youtubeVideo
