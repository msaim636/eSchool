...
class ResultOnlineScreen extends StatefulWidget {
  const ResultOnlineScreen({
    required this.examId, required this.examName, required this.subjectName, super.key,
    this.childId,
    this.totalMarks,
    this.obtainedMarks,
  });
...
class ResultOnlineScreenState extends State<ResultOnlineScreen> {
                    ...
                    children: [
                      Align(
                        ...
                        child: buildQuestionCountContainer(
                          questionsCount: result.correctAnswers!.totalQuestions
                              .toString(),
  ...
  Widget shimmerRowContainer(BoxConstraints boxConstraints) {
    return Row(
      children: [
        ...
        SizedBox(width: boxConstraints.maxWidth * 0.055),
        CustomShimmerContainer(
          borderRadius: 20,
          height: boxConstraints.maxWidth * 0.305,
          width: boxConstraints.maxWidth * 0.47,
  ...
  Container buildShimmerLoadingResultDetailsContainer() {
    return Container(
      ...
      padding: EdgeInsets.only(
        bottom: 15,
        top: MediaQuery.sizeOf(context).height * 0.285 + 15,
      ),
      child: LayoutBuilder(
        builder: (context, boxConstraints) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Align(alignment: Alignment.topCenter, child: buildResultAppBar()),
        ],
      ),
    );
  }
