          ...
          >(
            listener: (context, state) {
              if (state is SelectElectiveSubjectsFailure) {
                ...
                context.read<StudentDashboardCubit>().updateElectiveSubjects(
                  electiveSubjects,
                );
          ...
          return Column(
            ...
            children: [
              ...
              const ShimmerLoadingContainer(
                child: CustomShimmerContainer(height: 80),
              ),
              const SizedBox(height: 20),
              const ShimmerLoadingContainer(
                child: CustomShimmerContainer(height: 80),
              ...
              listener: (context, state) {
                if (state is ClassElectiveSubjectsFetchSuccess) {
                  ...
                  for (final electiveSubjectGroup
                    ...
                    selectedElectiveSubjects.addAll({
                      electiveSubjectGroup.id: [],
                    });
                  }
                  setState(() {});
                }
