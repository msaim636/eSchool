...
class ChildTeachersScreen extends StatefulWidget {
  const ChildTeachersScreen({required this.childId, super.key});
  final int childId;
...
class _ChildTeachersScreenState extends State<ChildTeachersScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      context.read<ChildTeachersCubit>().fetchChildTeachers(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: boxConstraints.maxHeight * 0.025),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Padding(
                        ...
                        SizedBox(width: boxConstraints.maxWidth * 0.02),
                        Text(
                          teacher.mobile,
                          maxLines: 1,
                          style: TextStyle(
