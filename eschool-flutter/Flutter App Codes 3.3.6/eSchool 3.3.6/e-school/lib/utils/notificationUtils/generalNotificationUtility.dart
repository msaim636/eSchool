...
class NotificationUtility {
  ...
  static Future<void> subscribeOrUnsubscribeToNotificationTopics({
    ...
    if (AuthRepository.getHaSubscribedToNotificationTopics() &&
      ...
      final topics = [
        if (isParent && Platform.isAndroid) 'parentsAndroid',
        if (isParent && Platform.isIOS) 'parentsIOS',
        if (!isParent && Platform.isAndroid) 'studentsAndroid',
        if (!isParent && Platform.isIOS) 'studentsIOS',
